...
Материалы заказчика, расчёт трудозатрат и `.env` в репозиторий не входят: он публичный. Когда нужно перевезти проект целиком и без GitHub, `.\scripts\make-transfer.ps1` кладёт в один архив историю git, эти файлы и слепок данных — с инструкцией внутри. Подробности — в [документации по развёртыванию](docs/deployment.md#7-резервное-копирование-и-перенос-на-другую-машину).
