...
Восстановление затирает базу принимающей машины, поэтому спрашивает подтверждение. Подробности — в [документации по развёртыванию](docs/deployment.md#7-резервное-копирование-и-перенос-на-другую-машину).
